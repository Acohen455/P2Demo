...
@CrossOrigin(value = {"http://localhost:5173", "http://myp2bucketbjp.s3-website-us-east-1.amazonaws.com/"}, allowCredentials = "true") //This annotation will allow requests from anywhere (like our React app)
public class AuthController {

    //autowire the AuthService to use its methods
    private final AuthService authService;

    //we also need to autowire the JWTTokenUtil and the AuthManager
